...
const userCtrl = {
    register: async (req, res) => {  // async/await for proper error handling
        try {
            ...
            sendMail(email, url, "Verify your email address") //send token to users email
    ...
    activateEmail: async (req, res) => {  //activiate user Email using asynchronous function
        try {
    ...
    login: async (req, res) => { //login async function (use promise to return value with the async function or reject it)
        try {
